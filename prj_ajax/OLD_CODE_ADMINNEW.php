...
<div class="container">
	...
	<h1><font color="red"><?php echo "Hello ".$_SESSION['username']; ?></font></h1>
	<br/>
	...
	<div class="form-group col-md-12">
		...
		<div class="form-group col-md-6">
			<div class="form-group col-md-6">
				<button name="filter" id="filter" class="btn btn-info">FILTER <span class="glyphicon glyphicon-calendar"></span></button>
			</div>	
	</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<a class="btn btn-danger" name="export1" id="csv" onclick="return confirm('Download As CSV?')">
						...
						<a href="fpdfdemo.php" class="btn btn-danger" name="export2"  onclick="return confirm('Download As PDF?')">
						...
						<div class="main-login-form">
							<div class="login-group">
								...
								<a href="logout.php" id="logout" class="btn btn-danger" onclick="return confirm('Are You sure you want to logout?')">Logout</a>
	...
	<script src="my_script.js"></script>
			...
			{
			$('#employee_data,#feeback').DataTable({
				responsive: true 
